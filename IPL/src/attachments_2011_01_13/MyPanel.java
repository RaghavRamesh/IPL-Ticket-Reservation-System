...
public class IPL 
{
    ...
    JButton jb_rr,jb_mi,jb_rcb,jb_csk,jb_kkr,jb_kp,jb_dd,jb_dc,jb_abtus,jb_sb,jb_bb,jb_ko,jb_pw;
    ...
    public IPL () 
	 ...
	 public void buildGUI()
	 {
        ...
        jb_pw = new JButton (new ImageIcon("punewar.jpg"));
...
class dc{
    ...
    public dc()
	  {
	     jf_dc = new JFrame("Chennai Super Kings");
