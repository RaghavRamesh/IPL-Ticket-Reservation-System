    ...
    public pu()
	 ...
	 void buildpu()
	 {
        ...
        jta_pusq = new JTextArea (5, 5);
		   ...
		   "the Pune IPL team at the 2010\n franchise auction for\n"+
		   "two new Indian Premier League teams. The bid was lost \n"+
		   "by The Videocon Group for the\n Pune IPL Team and for Rs 1,70\n"+
		   "2 crore Sahara group bought it on March 22, 2010. It was named\n"+
		   "as Sahara Pune Warriors\n at a function held at Pune on 24 April 2010.\n"+
		   "Sahara group declared its Pune IPL team \nname and revealed its logo at\n"+
		   "S.P. College ground in \nwhich Bollywood actress Urmila Matondkar and \n"+
		   "producer-director Mahesh Manjerekar began with a cultural programme. \n"+
		   "In the MCA Pune International Cricket \nCentre ground situated at Gahunje \n"+
		   "almost 25 km from Pune, the new IPL Team\n Sahara Pune Warriors will play \n"+
		   "their home matches."); 
        
		jta_suppu.setText("           Support Staff:\n"+
                             "Praveen Amre Assistant\n"+"Coach of Sahara \n"+"Pune Warriors"); 
    ...
    public ko()
	 ...
	 void buildko()
	 {
        ...
        jta_kosq = new JTextArea (5, 5);
		  ...
		  "the auction was set on March 22, 2010 in \n"+
		  "which total 12 teams\n participated including \n"+
		  "Ahmedabad, Rajkot, Cuttack, Kanpur\n "+
		  "Vadodara, Kochi, Indore, Dharamsala, Pune, Nagpur,\n"+ 
		  "Gwalior and Vizag.From these 12 teams, Sahara Group \n"+
		  "was biding Pune team with highest cost \n"+ 
		  "of Rs.1,702 crore named as Sahara Pune Warriors \n"+
		  "alongside Rendezvous Sports World was on second big \n"+
		  "bid for the team Kochi at cost of Rs.1533.32 crores \n"+ 
		  "and it is Kochi IPL Team.\n Total purchase price of both \n"+
		  "new franchises is reportedly more than all original eight \n"+
		  "IPL franchises’ purchase price."); 
