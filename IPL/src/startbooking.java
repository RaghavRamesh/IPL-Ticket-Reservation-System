...
public class startbooking extends JPanel {
    ...
    public startbooking() {
        ...
        jlbl_tic.setBounds (170, 205, 85, 25);
        jt_tic.setBounds (250, 205, 45, 25);
        jl_price.setBounds (170, 235, 40, 25);
        jt_price.setBounds (265, 235, 100, 25);
        jl_rupee.setBounds (240, 235, 20, 25);
        jb_chkav.setBounds (165, 170, 135, 25);
        jb_booknow.setBounds (170, 265, 130, 25);
        jb_choose.setBounds (305, 170, 80, 25);
        jb_home.setBounds (305, 265, 80, 25);
    }


    public static void main (String[] args) {
        JFrame frame = new JFrame ("startbooking");
        frame.setDefaultCloseOperation (JFrame.EXIT_ON_CLOSE);
        frame.getContentPane().add (new startbooking());
        frame.pack();
